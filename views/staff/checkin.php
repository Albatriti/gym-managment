...
$checkins = $db->query("
    SELECT c.*, CONCAT(u.first_name, ' ', u.last_name) as member_name
    FROM checkins c
...
<head>
    ...
    <title>Check-In — GymFlow Staff</title>
...
<body>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="color:var(--text-muted);font-size:0.82rem;"><?php echo date('H:i', strtotime($c['checkin_time'])); ?></td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const links = [{
                    href: '/gym-managment/views/staff/dashboard.php',
                    icon: '📊',
                    label: 'Dashboard',
                    id: 'dashboard'
                },
                {
                    href: '/gym-managment/views/staff/checkin.php',
                    icon: '✅',
                    label: 'Check-In',
                    id: 'checkin'
                },
                {
                    href: '/gym-managment/views/staff/payments.php',
                    icon: '💳',
                    label: 'Pagesat',
                    id: 'payments'
                },
