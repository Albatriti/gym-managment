...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add') {
    // Krijo user fictiv vetëm për lidhjen me DB — trajneri nuk kyçet kurrë
    $fakeEmail = 'trainer.' . time() . '@apexgym.internal';
    ...
    $stmt->execute([':fn' => $_POST['first_name'], ':ln' => $_POST['last_name'], ':email' => $fakeEmail, ':pass' => $fakePass]);
    ...
    $_SESSION['flash'] = ['type' => 'success', 'message' => 'Trajneri u shtua me sukses!'];
